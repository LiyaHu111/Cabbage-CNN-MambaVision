...
config.dataset.name = 'Cabbage6'
config.dataset.train_dataset_dir = './data/Cabbage6/train'
config.dataset.test_dataset_dir = './data/Cabbage6/test'
config.dataset.image_size = 256
config.dataset.n_channels = 3
config.dataset.n_classes = 6

config.model = ConfigNode()
config.model.type = 'cabbage'
